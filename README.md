...
- `tarefas_qwen`      nome tecnico em snake_case (ex: lista_compras)
- `Tarefas Qwen`   nome visivel (ex: Lista de Compras)
- `org.kata.tarefasqwen`        package id (ex: org.kata.listacompras)
- `2026`          ano atual
